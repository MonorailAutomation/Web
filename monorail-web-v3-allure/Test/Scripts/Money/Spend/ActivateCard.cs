using System;
using monorail_web_v3.Database;
...
namespace monorail_web_v3.Test.Scripts.Money.Spend
{
    ...
    internal class ActivateCard : FunctionalTesting
    {
        ...
        public void ActivateCardTest()
        {
            ...
            const string userPrefix = "autotests.mono+23.271221%";

            var username = RetrieveUser.GetUserAfterQ2SpendOnboardingWithoutCard(userPrefix);
            ...
            DestroyUser.ChangeLastName(username);
        }
    }
}