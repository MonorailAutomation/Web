...
namespace monorail_web_v3.PageObjects.MoneyScreens.SpendScreen.Modals.TransactionModals
{
    public class SpendWithdrawCashModal : WithdrawCashModal
    {
        ...
        public SpendWithdrawCashModal(IWebDriver driver) : base(driver)
        {
