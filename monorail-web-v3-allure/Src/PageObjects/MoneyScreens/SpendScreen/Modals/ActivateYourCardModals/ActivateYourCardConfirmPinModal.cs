...
{
    public class ActivateYourCardConfirmPinModal : Modal
    {
        private const string ActivateYourCardHeaderText = "Activate your card";
        private const string PinMessageText = "Confirm your pin";

        [FindsBy(How = How.XPath, Using = "//div[@class='vim-modal__body__content']//p")]
        private IWebElement _pinMessage;

        public ActivateYourCardConfirmPinModal(IWebDriver driver) : base(driver)
        {
            PageFactory.InitElements(driver, this);
        }

        [AllureStep("Enter PIN: ${0}")]
        public ActivateYourCardConfirmPinModal EnterPin(string pin)
        {
        ...
        public ActivateYourCardConfirmPinModal CheckActivateYourCardConfirmPinModal()
        {
            try
            {
