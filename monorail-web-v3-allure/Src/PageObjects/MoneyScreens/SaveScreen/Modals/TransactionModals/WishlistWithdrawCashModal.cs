...
namespace monorail_web_v3.PageObjects.MoneyScreens.SaveScreen.Modals.TransactionModals
{
    public class TrackWithdrawCashModal : WithdrawCashModal
    {
        ...
        public TrackWithdrawCashModal(IWebDriver driver) : base(driver)
        {
            PageFactory.InitElements(driver, this);
        }

        [AllureStep("Check 'Withdraw Cash' modal")]
        public TrackWithdrawCashModal CheckTrackWithdrawCashModal()
        {
            try
            {
